...
;(function (global, factory) {
  ...
  function genericLineIntersection(
    aStart,
    aEnd,
    bStart,
    bEnd,
    ...
    const ua =
      (dxb * (aStart.y - bStart.y) - dyb * (aStart.x - bStart.x)) / denominator
    const ub =
      (dxa * (aStart.y - bStart.y) - dya * (aStart.x - bStart.x)) / denominator
